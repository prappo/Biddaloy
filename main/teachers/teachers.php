                  ...
                  <div class="col-md-12 personal-info">
                    <form class="form-horizontal" id="teachers_edit_form" role="form" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-8">
                          <input type="file" name="new-teacher-image" class="file-pos" id="photo" accept="image/*">
                        </div>
                      </div>
                  </div>
              </div>
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <form class="form-horizontal" id="teachers_edit_form" role="form" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-8">
                  <input type="file" name="edit-teachers-image" class="file-pos" id="photo" accept="image/*">
                </div>
                </div>
              </div>
            </div>
