                  ...
                  <div class="col-md-12 personal-info">
                    <form class="form-horizontal" id="students_edit_form" role="form" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-8">
                          <input type="file" name="new-student-image" class="file-pos" id="photo" accept="image/*">
                        </div>
                      </div>
                    </div>
                  </div>
						  ...
						  <div class="col-md-12 personal-info">
							<form class="form-horizontal" id="students_edit_form" role="form" method="post" enctype="multipart/form-data">
							  ...
							  <div class="form-group">
								...
								<div class="col-md-8">
								  <input type="file" name="edit-students-image" class="file-pos" id="photo" accept="image/*">
								</div>
							  </div>
							</div>
						  </div>
